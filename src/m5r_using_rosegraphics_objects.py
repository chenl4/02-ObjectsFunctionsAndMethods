...
#                .clone(),._get_coordinates_for_drawing(),.get_bounding_box()
#
...
#            It is important at the last of the program, since it helps stop it
#           and you don't have to move your mouse a lot.
#
